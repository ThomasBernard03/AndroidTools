...
import fr.thomasbernard03.androidtools.presentation.fileexplorer.FileExplorerScreen
import fr.thomasbernard03.androidtools.presentation.fileexplorer.FileExplorerViewModel
...
fun NavGraphBuilder.mainNavigationGraph(){
    ...
    composable(Screen.FileExplorer.route){
        val viewModel = viewModel { FileExplorerViewModel() }
        val uiState by viewModel.uiState.collectAsStateWithLifecycle()
        FileExplorerScreen(uiState = uiState, onEvent = viewModel::onEvent)
    }
}